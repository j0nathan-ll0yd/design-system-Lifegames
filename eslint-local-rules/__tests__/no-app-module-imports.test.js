...
tester.run('no-app-module-imports', rule, {
  valid: [
    ...
    {
      filename: widgetFile,
      code: "import { classifyHeartRate } from '../../runtime/heart-rate';",
    },
    ...
    {
      filename: widgetFile,
      code: 'function load() { return fetch("/x"); }',
    },
  ...
  invalid: [
    ...
    {
      filename: widgetFile,
      code: "import { get } from '../../lib/api';",
      errors: [{ messageId: 'forbiddenImport', data: { source: '../../lib/api' } }],
    },
    // Store import.
    {
      filename: widgetFile,
    ...
    // Third-party http client.
    {
      ...
      errors: [{ messageId: 'forbiddenImport', data: { source: 'axios' } }],
    },
    // Module-scope fetch.
    {
      filename: widgetFile,
      code: 'const data = fetch("/api/health");',
      errors: [{ messageId: 'moduleScopeFetch' }],
    },
  ],
});

...
tester.run('no-deprecated-tokens', freshR, {
  valid: [
    // Non-deprecated CSS var — no warning
    {
      ...
      code: 'const s = "var(--lg-color-surface-base)";',
    },
    // Non-deprecated Swift accessor — no warning
    {
      filename: syntheticFile,
      code: 'const s = "LGColor.surfaceBase";',
    },
    ...
    {
      filename: '/tmp/outside-project/Foo.ts',
  ...
  invalid: [
    ...
    {
      filename: syntheticFile,
      code: 'const s = "Color.deprecatedTwo";',
      errors: [{ messageId: 'deprecatedSwiftAccess', data: { name: 'Color.deprecatedTwo' } }],
    },

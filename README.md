...
packages/web     @lifegames/web — Astro components, 37 page-specific widgets, Storybook stories
...
| `@lifegames/web` | Astro | Web components and 37 widgets |
...
| `LifegamesWidgets` | Swift | 37 SwiftUI widget ports |

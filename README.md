...
packages/web     @lifegames/web — Astro components, 55 page-specific widgets, Storybook stories
...
| `@lifegames/web` | Astro | Web components and 55 widgets |
...
| `LifegamesWidgets` | Swift | 55 SwiftUI widget ports |

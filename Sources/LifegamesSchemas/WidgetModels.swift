// Generated by packages/schemas/scripts/codegen.ts via quicktype.
// Do NOT hand-edit. Run `pnpm sync:schemas && pnpm -F @lifegames/schemas codegen`
// and copy the new output here. CI guards freshness via check:schemas-freshness.
// Source schemas: packages/schemas/{vendored,authored}/*.schema.json
...
struct DashboardGithub: Codable {
    ...
    let stats: DashboardGithubStats?
...
extension DashboardGithub {
    ...
    func with(
        ...
        stats: DashboardGithubStats?? = nil,
        streak: Streak? = nil,
...
/// High-level summary statistics displayed in the widget header.
// MARK: - DashboardGithubStats

struct DashboardGithubStats: Codable {
...
// MARK: DashboardGithubStats convenience initializers and mutators

extension DashboardGithubStats {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(DashboardGithubStats.self, from: data)
    }
    ...
    func with(
        ...
        repos: Int? = nil,
        stars: Int? = nil
    ) -> DashboardGithubStats {
        return DashboardGithubStats(
            contributions: contributions ?? self.contributions,
            repos: repos ?? self.repos,
...
// MARK: DashboardBook convenience initializers and mutators

extension DashboardBook {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(DashboardBook.self, from: data)
    }

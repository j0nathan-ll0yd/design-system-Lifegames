...
export function createStarredRepo(overrides?: Partial<StarredRepo>): StarredRepo {
  return {
    ...
    name: 'mantle',
    htmlUrl: 'https://github.com/j0nathan-ll0yd/mantle',
    description: 'A typed serverless application framework',
    forksCount: 12,
    stargazersCount: 128,
    watchersCount: 128,
    openIssuesCount: 4,
    topics: ['serverless', 'typescript', 'framework'],
    size: 32768,
    licenseKey: 'mit',
  ...
  return {
    ...
    repos: [
      ...
      createStarredRepo({
        ...
        description: 'A vector index for semantic search',
        forksCount: 1,
        stargazersCount: 5,
        watchersCount: 5,
        openIssuesCount: 0,
        topics: ['vector', 'search', 'index'],
        size: 4096,
        licenseKey: null,
        licenseName: null,
        licenseSpdxId: null,

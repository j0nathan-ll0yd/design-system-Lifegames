...
for (const f of authored) {
  ...
  raw = raw.replace(/"\$ref":\s*"\.\.\/vendored\/([^"#]+\.schema\.json)([^"]*)"/g, (_, file, frag) =>
...
for (const m of mapping) {
  ...
  results.push({
    ...
    mismatches: ok
      ? []
      : validate.errors.map((e) => ({path: e.instancePath || '(root)', keyword: e.keyword, message: e.message, params: e.params}))
  })
}

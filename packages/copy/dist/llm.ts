...
export interface LlmMcp {
  ...
  toolGetCurrentReading: string;
  toolGetTechStack: string;
  stackFramework: string;
  stackHosting: string;
  stackLiveData: string;
  stackDesign: string;
  stackFont: string;
  dsHealthName: string;
  dsHealthDesc: string;
  ...
  dsFocusName: string;
  dsFocusDesc: string;
  dsGithubEventsName: string;
  dsGithubEventsDesc: string;
  dsStarredReposName: string;
  dsStarredReposDesc: string;
  dsBooksName: string;
  dsBooksDesc: string;
  dsArticlesName: string;
  dsArticlesDesc: string;
  dsTheatreReviewsName: string;

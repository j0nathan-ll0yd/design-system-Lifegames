...
const meta: Meta = {
  ...
  argTypes: {name: {control: 'text'}, title: {control: 'text'}, bio: {control: 'text'}, github: {control: 'text'}, linkedin: {control: 'text'}},
  render: (args) =>
    html`
...
export const Empty: Story = {args: {name: '', title: '', bio: '', github: null, linkedin: null}}

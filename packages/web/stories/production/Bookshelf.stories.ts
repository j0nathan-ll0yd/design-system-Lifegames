...
const statusColor: Record<string, string> = {
  in_progress: 'var(--lg-color-accent-blue)',
  completed: 'var(--lg-color-accent-green)',
  next: 'var(--lg-color-text-muted)'
}
...
function renderBookshelf(books: typeof defaultBooks) {
  ...
  return html`
    ...
    books.map((b) =>
      html`
            <div
              style="display: flex; justify-content: space-between; align-items: flex-start; padding: 8px 0; border-bottom: 1px solid var(--lg-color-border);"
            >
        ...
        b.progress != null
          ...
          : ''
              ...
              <span
                style="font-size: 0.75em; color: ${statusColor[b.status] ?? 'inherit'}; margin-left: 8px; white-space: nowrap;"

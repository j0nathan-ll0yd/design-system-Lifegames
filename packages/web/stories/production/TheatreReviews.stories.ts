...
const defaultReviews = [
  {
    ...
    ratingNumeric: 9,
    excerpt:
      'A sharp, witty examination of friendship tested by the purchase of an expensive white painting.',
  ...
  },
  {
    ...
    ratingNumeric: 8,
    excerpt:
      'A raucous, genre-bending musical that brings an obscure historical figure to vivid life.',
      ...
      <div class="widget-body" style="padding: 8px 16px; color: var(--lg-color-text-primary);">
        ${reviews.map(
          (r) => html`
            ...
            >
              <div
                style="font-size: 1.3em; font-weight: bold; color: ${ratingColor(
                  r.ratingNumeric,

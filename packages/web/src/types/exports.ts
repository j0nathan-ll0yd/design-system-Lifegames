...
export interface ArticlesExport {
  ...
  articles: {
    ...
    savedAt: string
    notes: {comment: string; savedBy: string | null; createdAt: string}[]
  }[]
}
...
export interface GithubEventsExport {
  generatedAt: string
  events: {type: string; repo: string; title: string; date: string; number?: number; hash?: string; additions?: number; deletions?: number}[]
}
...
export interface HealthExport {
  date: string
  generatedAt: string
  quantities: {[k: string]: {value: number; unit: string}}
...
export interface WorkoutsExport {
  date: string
  generatedAt: string
  workouts: {activityType: string; duration: number | null; energyBurned: number | null; distance: number | null; source: string}[]
}

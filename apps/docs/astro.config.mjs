          ...
          items: [
            {
              ...
              items: [
                ...
                { label: 'CodeVelocity', link: '/alternates/github/code-velocity/' },
                { label: 'CodingHours', link: '/alternates/github/coding-hours/' },
                { label: 'CommitLog', link: '/alternates/github/commit-log/' },
                { label: 'CommitTimeline', link: '/alternates/github/commit-timeline/' },
                { label: 'ContributionBreakdown', link: '/alternates/github/contribution-breakdown/' },
                { label: 'ContributionCalendar', link: '/alternates/github/contribution-calendar/' },
                { label: 'ContributionGrid', link: '/alternates/github/contribution-grid/' },
                { label: 'ContributionRings', link: '/alternates/github/contribution-rings/' },
                { label: 'DevActivityByRepo', link: '/alternates/github/dev-activity-by-repo/' },
                { label: 'DevActivityCards', link: '/alternates/github/dev-activity-cards/' },
                { label: 'DevActivityPulse', link: '/alternates/github/dev-activity-pulse/' },
                ...
                { label: 'LanguageGrid', link: '/alternates/github/language-grid/' },
                { label: 'LanguageStack', link: '/alternates/github/language-stack/' },
                { label: 'PinnedRepos', link: '/alternates/github/pinned-repos/' },
                { label: 'ProfileCard', link: '/alternates/github/profile-card/' },
                { label: 'RepoShowcase', link: '/alternates/github/repo-showcase/' },
                { label: 'StarredByLanguage', link: '/alternates/github/starred-by-language/' },
                { label: 'StarredRepoCards', link: '/alternates/github/starred-repo-cards/' },
                { label: 'StarredTimeline', link: '/alternates/github/starred-timeline/' },
                { label: 'StreakCounter', link: '/alternates/github/streak-counter/' },
                { label: 'TopRepos', link: '/alternates/github/top-repos/' },
                { label: 'TopicCloud', link: '/alternates/github/topic-cloud/' },
                { label: 'WeeklyPulse', link: '/alternates/github/weekly-pulse/' },
                { label: 'YearInReview', link: '/alternates/github/year-in-review/' },
              ],
            },
            {
              label: 'Location',

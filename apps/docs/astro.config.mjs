      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {label: 'Reading', collapsed: true, items: [{label: 'BookModal', link: '/alternates/reading/book-modal/'}]},
            {label: 'Identity', collapsed: true, items: [{label: 'ComingSoon', link: '/alternates/identity/coming-soon/'}]},
            {
              label: 'Other',
              collapsed: true,
              items: [
